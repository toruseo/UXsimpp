...
int main(){
    ...
    for (int i=0; i<imax; i++){
        for (int j=0; j<imax; j++){
            add_demand(w, "node" + coord(0,i), "node" + coord(imax-1,j), 0,   6000, 0.02); 
            add_demand(w, "node" + coord(i,0), "node" + coord(j,imax-1), 0,   6000, 0.02);
            add_demand(w, "node" + coord(imax-1,i), "node" + coord(0,j), 0,   6000, 0.02); 
            add_demand(w, "node" + coord(i,imax-1), "node" + coord(j,0), 0,   6000, 0.02);
        }
    }
